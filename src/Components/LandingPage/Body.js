  ...
  return (
    ...
    <div className="row m-3" >
        <div className="col-md d-flex justify-content-center align-items-center bg-danger rounded-5">
            <div className="container text-light">
                <h3 className="fw-bold p-3" >" Never let the fear of striking out keep you from playing the game."</h3>
            </div>
        </div>
    ...
    <div className="row m-3" >
        ...
        <div className="col-md d-flex justify-content-center align-items-center bg-danger rounded-4">
            <div className="container text-light">
                <h3 className="fw-bold p-3" >" In the end, it's not the years in your life that count. "</h3>
            </div>
        </div>
    </div>
</div>
